...
ActiveRecord::Schema.define(version: 2021_01_12_120030) do
  ...
  create_table "shipping_areas", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_management_id"], name: "index_shipping_areas_on_purchase_management_id"
  end
  ...
  add_foreign_key "shipping_areas", "purchase_managements"
end
